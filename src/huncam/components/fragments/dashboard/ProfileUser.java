 ...
 * @author wilia
 */
public class ProfileUser extends javax.swing.JDialog {

    /**
     * Creates new form ProfileUser
     */
    public ProfileUser(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ProfileUser dialog = new ProfileUser(new javax.swing.JFrame(), true);
